...
//    private let carrierArray = ["Public", "Private"]
    ...
    {
        var multiplierVal : CGFloat = 0.1
        if (!hide)
        {
            multiplierVal = 50
        }
        
        taxiHigh.constant = multiplierVal
    ...
    func showCarrierView(_ hide : Bool)
    {
        ...
        hideCarrierView.constant = multiplierVal
    ...
    func hideMyPAShowView(_ hide: Bool) {
        ...
        {
            ownerTop.constant = 0
            constraintV = common.ShowAndHideView(ConstarintIs: PAShow, isHidden: hide, andSize: 0.000000001)
        }
        else
        {
        ...
        PAShow = constraintV
        constraintV = nil
        NSLayoutConstraint.activate([PAShow])
