//
//  GetMotorCarPlansViewController.swift
//  InsuranceApp
//
...
class GetMotorCarPlansViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITextFieldDelegate, UIScrollViewDelegate
{
    ...
    @IBOutlet weak var emergencyCoverView: UIView!//100015
    @IBOutlet weak var zeroDepView: UIView!//100016
    @IBOutlet weak var consumableView: UIView!//100017
    @IBOutlet weak var tyreCverView: UIView!//100018
    @IBOutlet weak var ncbProtectView: UIView!//100019
    @IBOutlet weak var engineProtView: UIView!//100020
    @IBOutlet weak var invoiceView: UIView!//100021
    @IBOutlet weak var lossKeyView: UIView!//100022
    @IBOutlet weak var lossPersBelView: UIView!//100023
    @IBOutlet weak var passAssiView: UIView!//100024
    @IBOutlet weak var hydroView: UIView!//100025
    @IBOutlet weak var hospitalView: UIView!//100026
    @IBOutlet weak var conveyanceView: UIView!//100027
    ...
    override func viewDidLoad() {
        ...
        APICallered().fetchData(Constant.apiAPI+Constant.baseURL+Constant.forApi+Constant.motor+Constant.privatecar+Constant.addon) { response in
    ...
    @objc func longPressGesture(_ sender: UITapGestureRecognizer? = nil) {
        if (thisTextField != nil)
        {
            thisTextField.resignFirstResponder()
        }
        ...
        UIPasteboard.general.string = quotationLabel.text
        let alertVu = SCLAlertView.init(appearance: self.common.alertwithCancel)
        alertVu.showSuccess("Quotation Copied.", subTitle: nil, closeButtonTitle: "Okay", timeout: .none, colorStyle: UInt(self.common.colorValue), colorTextButton: .max, circleIconImage: nil, animationStyle: .noAnimation)
    }
    
    private func allGseturedAdded()
    {
        let longpress = UITapGestureRecognizer.init(target: self, action: #selector(longPressGesture(_:)))
        quotationLabel.addGestureRecognizer(longpress)
        ...
        let addon_tap_1 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        ...
        let addon_tap_4 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_5 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        ...
        let addon_tap_8 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_9 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_10 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_11 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_12 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_13 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        let addon_tap_14 = UITapGestureRecognizer.init(target: self, action: #selector(showCheckAndUncheck(_:)))
        emergencyCoverView.addGestureRecognizer(addon_tap_1)
        zeroDepView.addGestureRecognizer(addon_tap_2)
        consumableView.addGestureRecognizer(addon_tap_3)
        tyreCverView.addGestureRecognizer(addon_tap_4)
        ncbProtectView.addGestureRecognizer(addon_tap_5)
        engineProtView.addGestureRecognizer(addon_tap_6)
        invoiceView.addGestureRecognizer(addon_tap_7)
        lossKeyView.addGestureRecognizer(addon_tap_8)
        lossPersBelView.addGestureRecognizer(addon_tap_9)
        passAssiView.addGestureRecognizer(addon_tap_10)
        hydroView.addGestureRecognizer(addon_tap_11)
        hospitalView.addGestureRecognizer(addon_tap_12)
        conveyanceView.addGestureRecognizer(addon_tap_13)
    ...
    private func getqualifiedList()
    {
        ...
        APICallered().POSTMethodForDataToGet(dataToPass: jsonObject, toURL: qualifyApi+Constant.privatecar+Constant.qualifyComp) { response in
            let planDict = response?.object(forKey: "Response") as? NSDictionary
            if (planDict != nil)
            {
                if (self.def.string(forKey: "QuotationNumber") == nil)
                {
    ...
    func loadPlansData(_ comapnyDictionary : NSDictionary, _ countVal : Int, _ totalVale: Int)
    {
        ...
        APICallered().POSTMethodForDataToGet(dataToPass: jsonD, toURL: self.qualifyApi+Constant.privatecar+comapnyCode) { response in
            DispatchQueue.main.async {
                if ((response) != nil)
                {
    ...
    private func loadCheckBoxes()
    {
        ...
        loadCheckBoxViews(emergencyCoverView, isSelected: def.bool(forKey: "IsEmergencyCover"))
        ...
        loadCheckBoxViews(tyreCverView, isSelected: def.bool(forKey: "IsTyreCover"))
        loadCheckBoxViews(ncbProtectView, isSelected: def.bool(forKey: "IsNCBProtection"))
        ...
        loadCheckBoxViews(lossKeyView, isSelected: def.bool(forKey: "IsLossOfKey"))
        loadCheckBoxViews(lossPersBelView, isSelected: def.bool(forKey: "IsLossOfPersonalBelonging"))
        loadCheckBoxViews(passAssiView, isSelected: def.bool(forKey: "IsPassengerAssistcover"))
        loadCheckBoxViews(hydroView, isSelected: def.bool(forKey: "IsHydrostaticLockCover"))
        loadCheckBoxViews(hospitalView, isSelected: def.bool(forKey: "IsHospitalCashCover"))
        loadCheckBoxViews(conveyanceView, isSelected: def.bool(forKey: "IsConveyanceCover"))
    ...
    private func checkBoxSelected(_ selectedVu : UIView, _isSelected isCheck : Bool)
    {
        ...
        case 100015:
            ...
            if (addonListArray != nil)
            {
                ...
                while(i < addonListArray!.count)
                {
                    ...
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Emergency Cover"))
                    {
                        if (isCheck)
                        {
            ...
            //                def.set(isCheck, forKey: "IsEmergencyCover")
            break
        case 100016:
            if (addonArray == nil)
            {
        ...
        case 100018:
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Tyre Cover"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsTyreCover")
            break
        case 100019:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("NCB Protection"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsNCBProtection")
            break
        case 100020:
            if (addonArray == nil)
            {
        ...
        case 100022:
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Loss of Key"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsLossOfKey")
            break
        case 100023:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Loss of personal Belonging"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsLossOfPersonalBelonging")
            break
        case 100024:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Passenger Assist cover"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsPassengerAssistcover")
            break
        case 100025:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Hydrostatic Lock Cover"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsHydrostaticLockCover")
            break
        case 100026:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Hospital Cash Cover"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsHospitalCashCover")
            break
        case 100027:
            if (addonArray == nil)
            {
            ...
            if (addonListArray != nil)
            {
                ...
                {
                    let aDict = addonListArray![i] as! NSDictionary
                    if ((aDict.object(forKey: "Name") as! String).elementsEqual("Conveyance Benefit"))
                    {
                        if (isCheck)
                        {
                            addonArray.add((aDict.object(forKey: "Id") as? String)!)
            ...
            //                def.set(isCheck, forKey: "IsConveyanceCover")
            break
        case 100028:
            if (addonArray == nil)
            {
