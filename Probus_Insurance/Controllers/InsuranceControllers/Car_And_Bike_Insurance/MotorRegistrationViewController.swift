...
//            let currentDay = calendar.component(.day, from: currentDate)
    ...
    private func displayForNewOrRenewal()
    {
        ...
        if (isNew) // bottom
        {
            heightConstraint = NSLayoutConstraint.init(item: heightForNew.firstItem as Any, attribute: heightForNew.firstAttribute, relatedBy: heightForNew.relation, toItem: heightForNew.secondItem, attribute: heightForNew.secondAttribute, multiplier: 0.0000001, constant: -20)
        }
        else
        {
            heightConstraint = NSLayoutConstraint.init(item: heightForNew.firstItem as Any, attribute: heightForNew.firstAttribute, relatedBy: heightForNew.relation, toItem: heightForNew.secondItem, attribute: heightForNew.secondAttribute, multiplier: 0.3, constant: 0)
        }
