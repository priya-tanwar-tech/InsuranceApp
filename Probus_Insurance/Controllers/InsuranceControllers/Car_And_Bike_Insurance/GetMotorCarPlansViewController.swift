...
class GetMotorCarPlansViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UITextFieldDelegate, UIScrollViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        APICallered().fetchData(common.A_P_I+common.baseURL+common.forApi+common.motor+common.privatecar+common.addon) { response in
    ...
    private func getqualifiedList()
    {
        ...
        APICallered().POSTMethodForDataToGet(dataToPass: jsonObject, toURL: qualifyApi+common.privatecar+common.qualifyCompany) { response in
    ...
    func loadPlansData(_ comapnyDictionary : NSDictionary, _ countVal : Int, _ totalVale: Int)
    {
        ...
        APICallered().POSTMethodForDataToGet(dataToPass: jsonD, toURL: self.qualifyApi+self.common.privatecar+comapnyCode) { response in
            DispatchQueue.main.async {
