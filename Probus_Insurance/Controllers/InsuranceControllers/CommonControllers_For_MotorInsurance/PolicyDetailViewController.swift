...
class PolicyDetailViewController : UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate
{
    ...
    func hideMyView(_ hide: Bool) {
        ...
        {
            claimTop.constant = 0
            constraintV = common.ShowAndHideView(ConstarintIs: claimHigh, isHidden: hide, andSize: 0.0000001)
        }
        else
        {
            claimTop.constant = 10
            constraintV = common.ShowAndHideView(ConstarintIs: claimHigh, isHidden: hide, andSize: 1)
        }
