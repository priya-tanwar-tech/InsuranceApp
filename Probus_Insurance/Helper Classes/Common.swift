...
class Common
{
    ...
    let buy = "https://buy"
    let testAPI = "https://testapi"
    let A_P_I = "https://api"
    let t_e_s_t = "https://test"
    let baseURL = ".probusinsurance.com/"
    let insurance = "insurance/"
    let car_insurance = "car-insurance/"
    let twowheel_insurance = "two-wheeler-insurance/"
    let commercialVehicleInsurance = "commercial-vehicle-insurance/"
    let goodsCarry_insurance = "goods-carrying/"
    let passCarry_insurance = "passenger-carrying/"
    let miscVeh_insurance = "misc-d/"
    let home = "Home/"
    let forApi = "api/"
    let motor = "Motor/"
    let privatecar = "PrivateCar/"
    let twowheeler = "TwoWheeler/"
    let gc_pc_misc_insurance = "GetCommercialInsuranceCompany/"
    let goodCommercial = "GoodsCommercialVehicle/"
    let passengerCommercial = "PassengerCommercialVehicle/"
    let miscCommercial = "Miscellaneousvehicle/"
    let addon = "AddOn"
    let vehicleBodyType = "VehicleBodyType"
    let VehicleUsagetype = "VehicleUsagetype"
    let vehicleColor = "VehicleColor"
    let stateBy = "StateByCompanyCode"
    let cityBy = "CityByState"
    let stateCode = "&stateCode="
    let pincode_check = "PincodeCheck?Pincode="
    let validCheck = "ChkValidVehicleRegNoBySubProduct"    
    let quotationDetails = "GetUserDetailsFromQuotation"
    let hypothet = "Hypothentication"
    let rtoCity = "RTOcityJson"
    let manufacturer = "ManufacturerJson"
    let model = "AllModelJson"
    let variant = "AllVariantJson"
    let probusRenewal = "PreviousInsurerForBrokerRenewal"
    let salutation = "Salutation"
    let maritalStatus = "MaritalStatus"
    let Relationship = "NomineeRelationship"
    let occupation = "Occupation"
    let company = "?companyCode="
    let companyId = "?companyId="
    let and_companyId = "&companyId="
    let termLife = "life/termlife/"
    let coverageAmount = "CoverageAmountWithWord"
    let VehilceRegisterationDetail = "GetRegistrationDetailMobile"
    let GetDetailsForProbusRenewal = "GetDetailsForProbusRenewal"
    let comp_specific_quote = "CompanySpecificQuotation"
    let proposal_req = "Proposal"
    let vNo = "?vehicleNumber="
    let tokenNumber = "&token="
    let subproduct = "&subproduct="
    let productCode = "&productCode="
    let subProductCode = "&subProductCode="
    let subProd_ID = "?subProductId="
    let mobileNumb = "?mobileNumber="
    let client = "Client/"
    let send_to_client_mob = "SendToClientMobile"
    let gen_otp = "GenerateOTP"
    let conf_val_otp = "ConfirmAndValidateOTP"
    let clientName = "&clientName="
    let emailId = "&emailId="
    let quot_Number = "?quotationNumber="
    let quotationNumber = "&quotationNumber="
    let MTRPC = "MTRPC"
    let HELIN = "HELIN"
    let HELFM = "HELFM"
    let MTRTW = "MTRTW"
    ...
    let MTRMV = "MTRMV"
    let MICMB = "MICMB"
    let qualifyCompany = "QualifiedCompany"
    let companylogo = "img/companylogo/"
    let brokerId = "?BrokerId="
    let device = "&DeviceId="
    let previousInsurerCode = "&previousInsurerCode="
    let prevPolicyNumb = "&previousPolicyNumber="
